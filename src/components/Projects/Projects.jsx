...
const projects = [
    ...
    },
    {
        ...
        description: "Story Flow is a news article website. Users can read news articles, post news articles. More in Github.",
        coreFeatures: [
    ...
    },
    {
        ...
        description: "Roomly Hotel is a hotel management web application. Users can book hotel rooms through this website. More in Github.",
        coreFeatures: [
            "Room booking system",
                    ...
                    <div key={project.projectName} className="card border transition-transform transform hover:scale-110 bg-[#392e6d] border-[#a38cfa] w-96 shadow-xl">
                        ...
                        <div className="card-body">
                            ...
                            <ul className="list-disc pl-5">
                                <h4 className="poppins-regular"><strong>Features : </strong></h4>
                                {project.coreFeatures.map((feature, index) => (
                                    <li key={index} className="poppins-regular">{feature}</li>
                                ))}
                            </ul>
                            <p className="poppins-regular mt-2"><strong>Technologies : </strong> {project.technologies}</p>
                        </div>
