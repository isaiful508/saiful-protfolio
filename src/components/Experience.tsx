...
const experienceData = [
  ...
  },
  {
    ...
    description: "Dove into Next.js to learn about server-side rendering and static site generation. Developed several projects to understand the benefits and use cases of Next.js in modern web development.",
    achievements: [
      "Mastered server-side rendering concepts",
      "Built static and dynamic websites",
      "Improved performance optimization skills"
    ]
  },
  {
    period: "2023",
        ...
        <div className="relative space-y-16">
          {experienceData.map((exp, index) => (
            ...
            >
              ...
              {/* Content card */}
              <motion.div 
                className={`w-1/2 bg-white dark:bg-gray-900 rounded-xl p-6 shadow-lg relative group ${
